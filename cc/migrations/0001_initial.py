    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('magicbyte', models.CharField(default='0,5', max_length=10, verbose_name='Magicbytes', validators=[validate_comma_separated_integer_list])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason_content_type', models.ForeignKey(blank=True, to='contenttypes.ContentType', null=True, on_delete=models.PROTECT)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(to='cc.Currency', on_delete=models.PROTECT)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(to='cc.Currency', on_delete=models.PROTECT)),
                ('wallet', models.ForeignKey(to='cc.Wallet', on_delete=models.PROTECT)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='wallet',
            field=models.ForeignKey(to='cc.Wallet', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='address',
            name='currency',
            field=models.ForeignKey(to='cc.Currency', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='address',
            name='wallet',
            field=models.ForeignKey(related_name='addresses', blank=True, to='cc.Wallet', null=True, on_delete=models.PROTECT),
            preserve_default=True,
        ),
    ]
